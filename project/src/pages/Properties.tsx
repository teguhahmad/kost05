...
import { Plus, Search, Building2, MapPin, Phone, Mail, Edit, Trash } from 'lucide-react';
...
const Properties: React.FC = () => {
  ...
  const handleFormSubmit = (data: Partial<Property>) => {
    const newProperty: Property = {
      ...
      ...data as Omit<Property, 'id' | 'created_at' | 'updated_at' | 'owner_id'>
    };
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button icon={<Plus size={16} />} onClick={handleAddProperty}>
          Tambah Properti
        </Button>
      </div>
