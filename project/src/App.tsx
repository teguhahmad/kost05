...
const UserContent: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Welcome to KostManager</h1>
      <p className="text-gray-600">This is the user interface view. Coming soon!</p>
    </div>
  );
};

const AppContent: React.FC = () => {
  const { isBackoffice } = useBackoffice();
  
  return (
    <>
      {isBackoffice ? <BackofficeContent /> : <UserContent />}
      <BackofficeSwitch />
    </>
  );
};
